...
const LinkApiComics=`https://gateway.marvel.com:443/v1/public/comics?format=comic&formatType=comic&noVariants=true&offset=${n=generarNumeroAleatorio()}&ts=1&apikey=ca1c2b6e8c6bf691ac82e03e1bf9574d&hash=0f13cd08901e3bd3c1f9fcef8b52d0f7`
...
async function ExtraerData(){
    try {
        ...
        if (ComicData) {
            ...
            console.log("No se encontraron datos de el comic.");
        }
    } catch (error) {
...
async function ImprimirComics(){
        ...
        divComic.addEventListener('click', function() {
            ...
            if (comicLinkURL) {
                ...
                console.log('No hay enlace de cómic disponible para este comic.');
            }
        });
    });
